...
BEGIN --Build Dates and Location matrix
	...
	VALUES ('30', 'Online NZ', 'New Zealand', '199'),
		   ('30', 'Online AU', 'Australia', '299'),
		   ('30', 'Online UK', 'United Kingdom', '799'),
		   ('50', 'International Online', 'United States', '196'),
		   --('50', 'International Wholesale', 'New Zealand', '197'), --Online is not responsible for deliverying wholesale revenue
		   ('30', 'International Online AU', 'Australia', '811'),
		   ('30', 'International Online NZ', 'New Zealand', '812')
	;
...
BEGIN -- get metrics
	...
	WHERE budget.dim_date_key between @start_date and @end_date
		and dl.location_type in (30, 50)
		and dl.location_name not in (N'Corporate Sales AU', N'Corporate Sales NZ', N'Corporate Sales UK')
...
select * from #DATE_STORE;
select * from #GET_BUDGET;
select * from #GET_SALES;
select * from #GET_WEB_METRICS;
