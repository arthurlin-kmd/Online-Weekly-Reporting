/*
Report: Key KPIs - last 7 days (mail order stores)
Job: 11925
Report Cache Used: Yes

Query Engine Execution Start Time:		18/01/2022 3:19:48 p.m.
Query Engine Execution Finish Time:		18/01/2022 3:19:55 p.m.

Query Generation Time:		0:00:00.06
Total Elapsed Time in Query Engine:		0:00:07.37
	Sum of Query Execution Time:		0:00:06.97
	Sum of Data Fetching and Processing Time:		264:21:09.05
		Sum of Data Transfer from Datasource(s) Time:		0:00:00.00
	Sum of Analytical Processing Time:		0:00:00.00
	Sum of Other Processing Time:		928:41:38.63
...
Pass1 - 	Query Pass Start Time:		18/01/2022 2:19:48 a.m.
	...
	Query Execution:	0:00:06.97
	Data Fetching and Processing:	264:21:09.05
	  Data Transfer from Datasource(s):	0:00:00.00
	Other Processing:	928:41:38.27
	Rows selected: 6
*/
...
from	(select	coalesce(pa11.acc_week_of_year, pa12.acc_week_of_year)  acc_week_of_year,
	...
	from	(select	a13.acc_week_of_year  acc_week_of_year,
		...
		where	(a13.full_date_datetime between '2022-01-10' and '2022-01-16'
		 and a12.location_type in (30, 50)
		 and a12.location_name not in (N'Corporate Sales AU', N'Corporate Sales NZ', N'Corporate Sales UK')
...
[Analytical engine calculation steps:
	...
	2.  Perform dynamic aggregation over <Week Of Year (Accounting), Location: Type, Location: Name, Location: Code>
